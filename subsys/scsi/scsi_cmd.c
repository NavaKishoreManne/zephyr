...
int scsi_cmd_read_16(struct scsi_xfer *xfer, uint64_t lba, uint32_t blocks,
...
int scsi_cmd_write_16(struct scsi_xfer *xfer, uint64_t lba, uint32_t blocks,
...
int scsi_cmd_read_10(struct scsi_xfer *xfer, uint32_t lba, uint16_t blocks,
		     void *buf, uint32_t len)
{
	int ret;
...
int scsi_cmd_write_10(struct scsi_xfer *xfer, uint32_t lba, uint16_t blocks,
		      const void *buf, uint32_t len)
{
	int ret;
...
int scsi_cmd_mode_sense_6_params(struct scsi_xfer *xfer, void *buf, uint32_t len,
