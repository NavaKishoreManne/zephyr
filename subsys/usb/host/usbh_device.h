...
/**
 * @brief Optional weak hook: bus thread calls this when enumeration reaches @ref USB_STATE_CONFIGURED
 *
 ...
 *
 * Called from the USB host bus thread before the device object is freed.
 * Override in the application to unmount file systems, release class
 * resources, or clear stale pointers to @a udev.
 *
